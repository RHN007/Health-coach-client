                ...
                <div className="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24">
                    ...
                    <form onSubmit={handleSubmit} className="mt-6">
                        <div className="relative">
                            <input className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="username" name='name' type="text" placeholder="Your Name" />
                        ...
                        <div className="relative mt-3">
                            <input className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="username" type="text" name='email' placeholder="Email" />
                            <div className="absolute left-0 inset-y-0 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 ml-3 text-gray-400 p-1" viewBox="0 0 20 20" fill="currentColor"            >
                        ...
                        <div className="relative mt-3">
                            <input className="appearance-none border pl-12 border-gray-100 shadow-sm focus:shadow-md focus:placeholder-gray-600  transition  rounded-md w-full py-3 text-gray-600 leading-tight focus:outline-none focus:ring-gray-600 focus:shadow-outline" id="username" type="text" name='password' placeholder="Password" />
                            <div className="absolute left-0 inset-y-0 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 ml-3 text-gray-400 p-1" viewBox="0 0 20 20" fill="currentColor"            >
                        ...
                        <div className="mt-4 flex items-center text-gray-500">          <input type="checkbox" onClick={handleAccepted} id="remember" name="remember" className="mr-2" />          <label className="text-sm" for="remember">I agree with the <a className="text-indigo-400 hover:text-indigo-500">Privacy Policy</a></label>        </div>
                        <div className="flex items-center justify-center mt-8">
                            <input className="btn border-none text-white py-2 px-4 uppercase rounded bg-primary hover:bg-indigo-600 shadow hover:shadow-lg font-medium transition transform hover:-translate-y-0.5" type="submit" value="Create Account" disabled={!accepted}/>  
                             </div>
                    </form>
                    <div>
                    ...
                    <div className='mt-4'>
                        <p className='text-center'>Already Registered ? Please  <Link to='/login'> <span className='text-primary'>Login</span> </Link> </p>
                    </div>
                </div>
            </div>
        </div>
